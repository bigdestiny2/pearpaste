// Paste — sandboxed preload (CJS by Electron requirement; repo is ESM).
// Boilerplate-verbatim from holepunchto/hello-pear-electron: exposes the
// worker IPC relay + update controls as window.bridge. The renderer's
// bridge-client auto-detects this surface (third transport).
